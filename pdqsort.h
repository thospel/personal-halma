...
namespace pdqsort_detail {
    ...
    template<class Iter, class Compare>
    inline std::pair<Iter, bool> partition_right_branchless(Iter begin, Iter end, Compare comp) ALWAYS_INLINE;
    template<class Iter, class Compare>
...
template<class Iter, class Compare>
inline void pdqsort_branchless(Iter begin, Iter end, Compare comp) ALWAYS_INLINE;
template<class Iter, class Compare>
...
template<class Iter>
inline void pdqsort_branchless(Iter begin, Iter end) ALWAYS_INLINE;
template<class Iter>
